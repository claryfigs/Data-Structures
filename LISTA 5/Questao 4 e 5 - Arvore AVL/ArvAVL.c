...
//formas diferentes de precorrer a arvore
...
//fazendo balancemento pela esquerda e direita
...
//procurando menor numero, tambem vale para direita
...
//chamando funções e definindo valores
